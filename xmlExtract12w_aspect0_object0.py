...
mycursor.execute("CREATE TABLE usptofigs14test_xwei (id INT PRIMARY KEY AUTO_INCREMENT, patentID VARCHAR(255), pid VARCHAR(255), is_multiple ENUM('0', '1'), origreftext VARCHAR(255), figid VARCHAR(255), subfig VARCHAR(32), is_caption ENUM('0', '1'), description VARCHAR(10000), aspect VARCHAR(1000), object VARCHAR(1000))")
...
def insertrow1(doc1, id1, multiple1, fig1, figid1, subfig1, text1, aspect, objectt) :
	sql = "INSERT INTO usptofigs14test_xwei (patentID, pid, is_multiple, origreftext, figid, subfig, is_caption, description, aspect, object) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
